...
def submit_form():
    ...
    t.sleep(0.5)
    #required emailhttps://docs.google.com/forms
...
window = tk.Tk()
window.title("Form details")

# Create a big frame to contain the input widgets
big_frame = tk.Frame(window, padx=100, pady=100)
big_frame.pack()

# Create a Label widget for the input prompt
prompt_label = tk.Label(big_frame, text="Enter the form Heading:")
prompt_label.pack()


# Create a Button widget to submit the form
button = tk.Button(big_frame, text="Submit", command=submit_form)
button.pack()
